...
void selective_scan_bwd_kernel(SSMParamsBwd params) {
    ...
    //retep is here
    input_t *ssm_initial_state = nullptr, *dssm_initial_state = nullptr;
    if (params.ssm_initial_state_ptr != nullptr){
        ...
        dssm_initial_state = reinterpret_cast<input_t *>(params.dssm_initial_state_ptr) + batch_id * params.dssm_initial_state_batch_stride
            + dim_id * params.dssm_initial_state_d_stride;
    }
    input_t* dlast_state = reinterpret_cast<input_t *>(params.dlast_state_ptr) + batch_id * params.dlast_state_batch_stride
